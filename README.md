...
<!-- ABOUT THE PROJECT -->
## About The Project
This is an implementation of an ingester to transform a Python pandas dataframe into the <a href="http://citrineinformatics.github.io/pif-documentation/index.html" target="blank">PIF</a> format.  
