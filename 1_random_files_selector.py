...
DEST_DIR = 'Randomized-selection-of-GDB-9-molecules'
...
def random_files_selector(*args):
    ...
    """
    parser = argparse.ArgumentParser(description='select a number of random files from "GDB-9-molecules-all" directory and copy to "GDB-9-molecules-pif"')
