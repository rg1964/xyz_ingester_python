...
def converter(*args):
    ...
    # the case when the user specifies a directory and list of files to be processed
    # from that directory
    if args.listd:
...
def parser_xyz(filepath):
    ...
    with open(filepath, 'r', encoding="ISO-8859-1") as fp:
        ...
        sect3 = ChemicalSystem()
        sect3.properties = []
        system.subsystem = [sect3]
        ...
        for i, line in enumerate(fp):
            if i == 0:
                ...
                system.properties.append(Property(name = sect4_properties(int(n_a), nr),
